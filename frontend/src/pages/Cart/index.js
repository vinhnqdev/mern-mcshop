    ...
    <div className="lg:grid grid-cols-6 gap-7">
      ...
      <div className="lg:col-span-4">
        ...
        {cart.length === 0 ? (
          ...
          <div className="bg-white shadow-sm rounded-md md:rounded-lg lg:rounded-xl mt-5">
      ...
      <div className="lg:col-span-2">
        {/** TotalPrice */}
        <div className="bg-white shadow-md rounded-md mt-7 p-4 space-y-3 lg:space-y-4">
        ...
        {/** Checkout */}
        <div className="bg-white shadow-md rounded-md mt-7 p-4 space-y-3">
          <MCButton
